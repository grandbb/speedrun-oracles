...
const deployedContracts = {
  11155111: {
    Decider: {
      address: "0x62612e3e1612459f848af4d6d36e9056d788b5b6",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 11738254,
    },
    OptimisticOracle: {
      address: "0xc458e7341363296a3b768072c1e9f8c1a4a8c50e",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 11738252,
    },
    ORA: {
      address: "0x6441bd95e34f81f25f428b9ca43e5e616e48907e",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 11738249,
    },
    StakingOracle: {
      address: "0xc2b8102e78715b51a4a0a64d7e75153e6c8e3c49",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 11738250,
    },
    WhitelistOracle: {
      address: "0x03ef1eabed691fc59802998884830cba0f2ddf48",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
